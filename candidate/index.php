...
background: linear-gradient(180deg, rgba(255,255,255,0.8) 0%, rgba(254,243,230,1) 100%);
  padding: 20px;
  width: 50%;
    box-shadow: 2px 2px 5px #dbaa70;
    margin-left: 25%;
    padding-bottom: 30px;
    scale: .95;
}
...
<body>
 ...
 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" style="border: none;">
  ...
  <div class="form-group col-lg-6">
      ...
      <input type="text" name="vid" required id="vid" placeholder="ID no" autocomplete="off">
    </div>
      <div class="form-group col-lg-6">
      <label for="fname">Name&nbsp;&nbsp;</label>
      <input type="text" name="fname" required id="fname" placeholder="Name" autocomplete="off">
    </div>
    <div class="form-group col-lg-6">
      <label for="age">Age&nbsp;&nbsp;</label>
      <input type="text" name="age" required id="age" placeholder="Age" autocomplete="off">
    </div>
    <div class="form-group col-lg-6">
      <label for="pname">Party name&nbsp;&nbsp;</label>
      <input type="text" name="pname" required id="pname" placeholder="Party name" autocomplete="off">
    </div>
      <div class="form-group col-lg-6">
    ...
    <div class="form-group col-lg-6">
      ...
      <input type="text" name="reg" required id="reg" placeholder="Region" autocomplete="off">
    </div>
    <div class="form-group col-lg-6">
  ...
  <input type="submit" class="btn btn-success shadow-lg" value="Submit" name="submit">
  
</form>
<span style="font-weight:bold;">Already Register!&nbsp;&nbsp;<a href="login.php"><input type="submit" class="btn btn-info" value="Login"></a></span>      
