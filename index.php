    ...
    <section class="rest">
        ...
        <div class="row">
            <div class="d-none d-lg-block col-lg-7">
                <img src="6386.webp" width="1000">
            </div>
            <div class="col-lg-5">
                <h1><b>Online Voting</b></h1>
                <h3>Landing Page</h3>
                <h5>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of
                    classical Latin literature from 45 BC, making it over 2000 years old. <a href="./admin" class="text-info text-decoration-none">Admin</a>
                </h5><br>
                <a href="user_login.php"><button class="square_btn">Vote now</button></a>
                <a href="./candidate/"><button class="square_btn2">Candidate Login</button></a>
            </div>
        </div>
    </section>
    <script>
