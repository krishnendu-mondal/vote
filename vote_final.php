 ...
 <section>
  ...
  &nbsp;&nbsp;<img src='candidate/upload/<?php echo $row['logo'] ?>'style="height: 100px;">
   ...
   <b><?php echo $row['name'];  ?></b><br><?php echo $row['party'];  ?>
        ...
        echo '<span class="ncf"><h2>  <i class="fa-solid fa-triangle-exclamation"></i> No Candidate found</h2></span>';
    }
    ?>
        <br>
          <br>
    ...
    <a href="logout.php" style="text-decoration:none; position: absolute; top: 4rem; right: 2rem;" ></i><input type="submit" style="box-shadow: 1px 1px 5px rgba(0,0,0,0.5);" class="btn btn-dark" value="Logout"></a>
