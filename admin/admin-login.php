...
background: linear-gradient(20deg, rgba(255,255,255,1) 0%, rgba(188,178,255,1) 100%);
    user-select: none;
}
::-webkit-scrollbar {
    display: none;
...
<section>
    ...
    <center><img src="login-pic.svg"></center><br>
            ...
            <input type="text" placeholder="Admin ID" name="vid" required autocomplete="off"><br><br>
